...
const TicketDetails = () => {
  return (
    <div className="max-w-sm text-white p-2 rounded-md">
      {/* Name and Email Section */}
      <div className="grid grid-cols-2 grid-rows-2 text-sm text-gray-300">
        <div
      ...
      {/* Special Request */}
      <div className="border-t border-gray-500 mt-1 pt-2 text-sm text-gray-300">
        <p>Special request?</p>
